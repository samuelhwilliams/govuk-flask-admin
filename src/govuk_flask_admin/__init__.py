...
class GovukFilterConverter(sqla_filters.FilterConverter):
    ...
    def _get_filter_list(self, column, filter_classes):
        ...
        for filter_class in filter_classes:
            ...
            if filter_class == sqla_filters.FilterEmpty or issubclass(filter_class, sqla_filters.FilterEmpty):
    ...
    @sqla_filters.filters.convert("UUIDType", "ColorType", "TimezoneType", "CurrencyType")
