...
from govuk_flask_admin import GovukFrontendTheme, GovukModelView, GovukFlaskAdmin
from app import User, Post, Account, Base
...
class TestListViewRendering:
    ...
    def test_first_column_is_link_when_can_edit(self, client, sample_users):
...
class TestListViewCanEdit:
    ...
    def app_with_readonly_view(self):
        ...
        govuk_flask_admin = GovukFlaskAdmin(app, service_name="Test Service")
        db = SQLAlchemy(app)
        ...
        with app.app_context():
            ...
            class ReadOnlyUserView(GovukModelView):
                can_edit = False
    ...
    def test_first_column_not_link_when_can_edit_false_and_no_view_details(self, app_with_readonly_view):
        ...
        with app.app_context():
            ...
            user = User(
                ...
                age=30,
                job="Test Job",
                favourite_colour=list(User.__table__.c.favourite_colour.type.enum_class)[0],
    ...
    def app_with_details_view(self):
        ...
        with app.app_context():
            ...
            class ViewOnlyUserView(GovukModelView):
                can_edit = False
    ...
    def test_first_column_links_to_details_when_can_edit_false_but_can_view_details_true(self, app_with_details_view):
