...
def db_session():
    ...
    records = [
        ...
        DateTimeTestModel(id=base_time + timedelta(microseconds=100000),
                  created_at=base_time + timedelta(microseconds=100000)),  # 0.1 sec later
        DateTimeTestModel(id=base_time + timedelta(microseconds=500000),
                  created_at=base_time + timedelta(microseconds=500000)),  # 0.5 sec later
        DateTimeTestModel(id=base_time + timedelta(microseconds=999999),
                  created_at=base_time + timedelta(microseconds=999999)),  # 0.999999 sec later
        DateTimeTestModel(id=base_time + timedelta(seconds=1),
                  created_at=base_time + timedelta(seconds=1)),  # Exactly 1 sec later
        DateTimeTestModel(id=base_time + timedelta(seconds=2),
                  created_at=base_time + timedelta(seconds=2)),  # 2 sec later
        DateTimeTestModel(id=base_time - timedelta(seconds=1),
                  created_at=base_time - timedelta(seconds=1)),  # 1 sec before
    ]
