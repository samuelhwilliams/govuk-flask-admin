...
class TestRelationships:
    ...
    @pytest.fixture
    def users_with_accounts(self, db, app, sample_users):
    ...
    def test_relationship_field_renders_as_select(self, client, users_with_accounts):
        ...
        response = client.get('/admin/account/new/')
    ...
    def test_can_create_with_relationship(self, client, sample_users, db):
        ...
        response = client.post('/admin/account/new/', data=data, follow_redirects=True)
        # TODO: Assert account created with correct user_id

    def test_can_edit_relationship(self, client, users_with_accounts, db):
        ...
        response = client.post(f'/admin/account/edit/?id={account.id}', data=data, follow_redirects=True)
