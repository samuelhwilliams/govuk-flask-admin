...
def test_app():
    ...
    # Configure Jinja2 loaders to find govuk-flask-admin templates
    app.jinja_options = {
        'loader': ChoiceLoader([
...
class DummyField:
    ...
    def __init__(self, name="test_field", label="Test Field", description=None,
                 choices=None, data=None, errors=None):
        self.name = name
        self.id = name
