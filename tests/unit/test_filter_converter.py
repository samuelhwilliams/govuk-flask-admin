"""Unit tests for GovukFilterConverter."""
import pytest
from flask_admin.contrib.sqla import filters as sqla_filters
from sqlalchemy import Column, Integer, String, Enum, DateTime, Boolean
from sqlalchemy.orm import declarative_base

from govuk_flask_admin import GovukFilterConverter
...
class TestGovukFilterConverter:
    """Test GovukFilterConverter customizations."""

    @pytest.fixture
    def converter(self):
        """Create a GovukFilterConverter instance."""
        return GovukFilterConverter()
